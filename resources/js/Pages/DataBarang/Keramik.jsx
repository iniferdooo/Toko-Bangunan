...
import { Popover } from "@headlessui/react"; // Import Popover

export default function Keramik({ keramik }) {
        ...
        router.post(
            ...
            },
            {
                onSuccess: (response) => {
                    ...
                    router.visit("/keranjang"); // Navigate to the cart page
                },
                onError: (error) => {
        ...
        <div className="bg-gray-500 dark:bg-gray-900">
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-100 md:text-5xl lg:text-6xl dark:text-white">
                    Ada berbagai keramik yang ada di toko kami
                </h1>

                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-12">
                    {keramik &&
                        keramik.barangs &&
                        keramik.barangs.map((barang) => {
                            return (
                                <div
                                    key={barang.id}
                                ...
                                >
                                    <a href="#">
                                        <img
                                            ...
                                            src={`/${barang.gambar}`} // Fixed interpolation
                                            alt="product image"
                                        />
                                    </a>
